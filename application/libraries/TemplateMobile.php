...
class TemplateMobile
{
    ...
    public function view($content, $data = null)
    {
        ...
        $this->_ci->load->view('template/mobile/header', $data);
        $this->_ci->load->view('template/alert', $data);
        $this->_ci->load->view('template/mobile/navbar', $data);
        $this->_ci->load->view($content, $data);
        $this->_ci->load->view('template/mobile/navigation', $data);
        $this->_ci->load->view('template/mobile/footer', $data);
    }
}
