...
<body>
<!-- ========== MAIN CONTENT ========== -->
<main id="content" role="main" class="overflow-hidden bg-custom">
<div class="row">
	<div class="col-12 text-right">
		<a href="<?= base_url();?>" class="btn btn-link text-secondary float-end"><i class="bi bi-chevron-compact-left"></i> Kembali ke beranda</a>
	</div>
</div>