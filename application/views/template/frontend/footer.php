  ...
  <footer class="bg-dark">
  	<div class="container pb-1 pb-lg-5">
  		<div class="row content-space-t-2">
  			<div class="col-lg-3 mb-7 mb-lg-0">
  				...
  				<div class="mb-5">
  					<a class="navbar-brand" href="<?= base_url();?>" aria-label="Logo">
  						<img class="navbar-brand-logo" src="<?= base_url();?><?= $web_logo;?>"
  				...
  				<ul class="list-unstyled list-py-1">
  					<li><a class="link-sm link-light" href="<?= base_url();?>"><i class="bi-geo-alt-fill me-1"></i> <?= $web_alamat;?></a></li>
  			...
  			<div class="col-sm">
  				...
  				<ul class="list-unstyled list-py-1 mb-5">
  					<li><a class="link-sm link-light" href="<?= site_url('pusat-bantuan');?>"><i class="bi-question-circle-fill me-1"></i> Pusat Bantuan</a>
  					</li>
  					<li><a class="link-sm link-light" href="tel:<?= $web_telepon;?>"><i class="bi-person-circle me-1"></i> Hubungi</a>
  					</li>
  				</ul>
  				<!-- End List -->
  			</div>
  			...
  			<div class="col-sm mb-3 mb-sm-0">
  				...
  				<ul class="list-inline list-separator list-separator-light mb-0">
  					<li class="list-inline-item">
  						<a class="link-sm link-light" href="<?= site_url('kebijakan-privasi');?>">Kebijakan Privasi</a>
  					</li>
  					<li class="list-inline-item">
  			...
  			<div class="col-sm-auto">
  				...
  				<ul class="list-inline mb-0">
					...
					<?php if(isset($sosmed_facebook)):?>
  					<li class="list-inline-item">
  						<a class="btn btn-soft-light btn-xs btn-icon" href="https://facebook.com/<?= $sosmed_facebook;?>">
  		...
  		<div class="w-md-85 text-lg-center mx-lg-auto">
  			<p class="text-white-50 small">&copy; 2022 Ngodingin. All rights reserved.</p>
