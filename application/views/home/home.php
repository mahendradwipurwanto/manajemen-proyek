    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-lg-5 col-xl-6">
    					...
    					<!-- Fancybox -->
    					<a class="video-player video-player-btn" href="https://www.youtube.com/watch?v=d4eDWc8g0e0"
    			...
    			<div class="devices-wrap devices-rotated-body">
    				...
    				<figure class="device-tablet" style="width: 27rem;">
    					<div class="device-tablet-frame">
    						<img class="device-tablet-img" src="<?= base_url();?>assets/img/1618x1010/img1.jpg"
    				...
    				<figure class="device-vertical-tablet" style="width: 18rem;">
    					<div class="device-vertical-tablet-frame">
    						<img class="device-vertical-tablet-img" src="<?= base_url();?>assets/img/533x711/img2.jpg"
    							alt="Image Description">
    					</div>
    				</figure>
    				...
    				<figure class="device-mobile align-self-start" style="width: 10rem;">
    					<div class="device-mobile-frame">
    						<img class="device-mobile-img" src="<?= base_url();?>assets/img/407x867/img5.jpg"
    							alt="Image Description">
    					</div>
    				</figure>
    				<!-- End Mobile Device -->
    				...
    				<figure class="device-browser" style="width: 35rem;">
    					...
    					<div class="device-browser-frame">
    						<img class="device-browser-img" src="<?= base_url();?>assets/img/1618x1010/img2.jpg"
    							alt="Image Description">
    					</div>
    				</figure>
    				<!-- End Browser Device -->
    		...
    		<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
    			...
    			<a class="card card-transition bg-light h-100 shadow-none overflow-hidden" href="#">
    				<div class="row align-items-center">
    					...
    					<div class="col-4 col-md-6 bg-img-end h-100 px-0"
    						style="background-image: url(<?= base_url();?>assets/svg/illustrations/apps.svg);"></div>
    					<!-- End Col -->
    				</div>
    				<!-- End Row -->
    			</a>
    		...
    		<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
    			...
    			<a class="card card-transition bg-light h-100 shadow-none overflow-hidden" href="#">
    				<div class="row align-items-center">
    					...
    					<div class="col-4 col-md-6 bg-img-end h-100 px-0"
    						style="background-image: url(<?= base_url();?>assets/svg/illustrations/calendar.svg);">
    					</div>
    					<!-- End Col -->
    				</div>
    				<!-- End Row -->
    		...
    		<div class="col-sm-6 col-lg-4">
    			...
    			<a class="card card-transition bg-light h-100 shadow-none overflow-hidden" href="#">
    				<div class="row align-items-center">
    					...
    					<div class="col-4 col-md-6 bg-img-end h-100 px-0"
    						style="background-image: url(<?= base_url();?>assets/svg/illustrations/communication.svg);">
    					</div>
    				</div>
    				<!-- End Row -->
    			</a>
    			...
    			<div class="col-lg-6 mb-9 mb-lg-0">
    				<div class="position-relative mx-auto" style="max-width: 20rem;">
    					...
    					<div class="position-absolute top-0 end-0 zi-2 me-n10 mt-9" style="width: 16rem;">
    						<img class="img-fluid shadow-lg rounded-2"
    							src="<?= base_url();?>assets/img/407x115/img1.jpg" alt="Image Description">
    					</div>
    					<!-- End Image -->
    					...
    					<div class="position-absolute bottom-0 start-0 zi-2 ms-n10 mb-10" style="width: 16rem;">
    						<img class="img-fluid shadow-lg rounded-2"
    							src="<?= base_url();?>assets/img/480x320/img26.jpg" alt="Image Description">
    					</div>
    					<!-- End Image -->

    					<!-- SVG Shape -->
    					<div class="position-absolute bottom-0 end-0 zi-n1 mx-auto" style="width: 20rem;">
    						<img class="img-fluid" src="<?= base_url();?>assets/svg/components/shape-1.svg" alt="SVG">
    					</div>
    					<!-- End SVG Shape -->
    				</div>
    			</div>
    					...
    					<li class="step-item mb-0">
    						<div class="step-content-wrapper">
    							...
    							<div class="step-content">
    								...
    								<p class="mb-0">We actively contribute to open-source projects—giving back to the
    									community through development, patches, and sponsorships.</p>
    							</div>
    						</div>
    					</li>
    				</ul>
    ...
    <div class="container content-space-b-2 content-space-b-lg-3">
    	...
    	<div class="text-center">
    		<div class="card card-info-link card-sm">
    			<div class="card-body">
    				Prefer to start with the Trial version? <a class="card-link ms-2" href="#">Go here <span
    		...
    		<div class="position-relative">
    			<div class="bg-light text-center rounded-2 p-4 p-md-7">
    				<img class="avatar avatar-lg avatar-4x3 mx-auto mb-4"
    					src="<?= base_url();?>assets/svg/brands/amazon-primary.svg" alt="SVG Logo">

    				<!-- Blockquote -->
    				<figure class="w-md-80 w-lg-50 mx-md-auto">
    					<blockquote class="blockquote">With Front, we're able to easily track our performance in full
    						detail. It's become an essential tool for us to grow and engage with our audience.
    					</blockquote>
    ...
    <div class="container content-space-2">
    	<div class="row justify-content-lg-between">
    		<div class="col-lg-5 mb-9 mb-lg-0">
    			<img class="avatar avatar-xxl avatar-4x3 mb-4"
    				src="<?= base_url();?>assets/svg/illustrations/app-wreath.svg" alt="SVG">

    			<!-- Heading -->
    			<div class="mb-5">
    				<h2>Award winning guides and resources</h2>
    				<p>Explore and learn more about everything from machine learning and global payments to building
    					marketplaces and scaling your team.</p>
    			</div>
    			<!-- End Heading -->
    			...
    			<div class="row">
    				<div class="col-sm-6">
    					...
    					<a class="d-block" href="#" data-aos="fade-left" data-aos-delay="100">
    						<img class="w-100 rounded-2" src="<?= base_url();?>assets/img/400x500/img26.jpg"
    							alt="Image Description">
    						<div class="py-4">
    				...
    				<div class="col-sm-6">
    					...
    					<a class="d-block" href="#" data-aos="fade-left">
    						<img class="w-100 rounded-2" src="<?= base_url();?>assets/img/400x500/img25.jpg"
    							alt="Image Description">
    						<div class="py-4">
