...
(15,'admin@manpro.com','$2y$10$1hg1pDmFo9NYLXLuKxr86.qZpBwWcFo.gQgLLye5Hsk9VXmZqdW12',1,1,NULL,NULL,1660484651,0,1660450439,0),
(16,'mahendradwipurwanto@gmail.com','$2y$10$4d3WK8ty16b90vQiDBNgN.5ECkfeFukiCvATnup.Ladd6Pwy07jVS',1,3,NULL,NULL,1660453154,0,1660450439,0),
(19,'ngodingin.indonesia@gmail.com','$2y$10$hZpfAuPSJozux/6RyvUxJuHLsUBXctLZz9YseCnmOhkghTsnB4XSG',1,2,NULL,NULL,1660482652,0,1660478436,0),
...
(16,'Mahendra Dwi Purwanto','assets/images/profile.png','085785111746','L',0,NULL,0),
...
/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `delete_user` BEFORE DELETE ON `tb_auth` FOR EACH ROW BEGIN
	DELETE FROM tb_user WHERE user_id = OLD.user_id;
    END */$$
