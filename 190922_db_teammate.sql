...
/*Table structure for table `tb_assign_leader` */
...
/*Data for the table `tb_assign_leader` */
...
(15,'admin@bagusproject.com','$2y$10$1hg1pDmFo9NYLXLuKxr86.qZpBwWcFo.gQgLLye5Hsk9VXmZqdW12',1,0,NULL,NULL,1663547414,0,1660450439,0);
...
/*Table structure for table `tb_komentar_task` */
...
/*Data for the table `tb_komentar_task` */
...
/*Table structure for table `tb_task_bukti` */
...
/*Data for the table `tb_task_bukti` */
