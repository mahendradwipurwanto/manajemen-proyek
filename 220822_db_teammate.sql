...
(4,2,16,1,1661090879,15,0,0,0),
(7,3,16,1,1661091716,15,0,0,0),
(8,2,24,1,1661157228,19,0,0,0);
...
(15,'admin@manpro.com','$2y$10$1hg1pDmFo9NYLXLuKxr86.qZpBwWcFo.gQgLLye5Hsk9VXmZqdW12',1,0,NULL,NULL,1661134563,0,1660450439,0),
(16,'mahendradwipurwanto@gmail.com','$2y$10$4d3WK8ty16b90vQiDBNgN.5ECkfeFukiCvATnup.Ladd6Pwy07jVS',1,3,NULL,NULL,1661157469,0,1660450439,0),
(19,'ngodingin.indonesia@gmail.com','$2y$10$hZpfAuPSJozux/6RyvUxJuHLsUBXctLZz9YseCnmOhkghTsnB4XSG',1,2,NULL,NULL,1661157078,0,1660478436,0),
...
insert  into `tb_proyek`(`id`,`kode`,`judul`,`keterangan`,`periode_mulai`,`periode_selesai`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`,`is_deleted`) values 
(2,'pyk01','Test Proyek','Testtt',1660582800,1660928400,1,1660669058,19,0,0,0),
(3,'pyk02','Test','\r\n						',1661014800,1663693200,1,1661086906,15,0,0,0),
(4,'pyk04','STIKI TECHN','',1661101200,1663779600,1,1661141712,15,0,0,0),
(6,'pyk06','PROYEK NEGARA','',1661360400,1664038800,1,1661147377,15,1661154649,15,0);
...
insert  into `tb_proyek_status`(`id`,`proyek_id`,`status`,`warna`,`keterangan`,`urutan`,`created_at`,`created_by`,`modified_at`,`modified_by`,`is_deleted`) values 
(2,6,'Todo','secondary','Status awal task yang baru dibuat',1,1661147377,15,0,0,0),
(3,6,'Inprogress','primary','Status untuk task dalam proses pengerjaan',2,1661147377,15,1661153852,15,0),
(4,6,'Done','warning','Status untuk task yang telah selesai',3,1661147377,15,1661153875,15,0),
(5,6,'Release','primary','\r\n						',1,1661153614,15,0,0,1),
(6,6,'Release','success','						',4,1661153841,15,1661153866,15,0);
...
('mailer_password','mjwbqwxziyvmvkhh',NULL,1653641032,0,0),
('mailer_port','587',NULL,1653641032,0,0),
('mailer_smtp','1',NULL,0,0,0),
('mailer_username','infohumanisapp@gmail.com',NULL,1653641032,0,0),
...
(3,'dyahajengsalsabilla@gmail.com',2,1,1661088091,15,1661089998,15,0);
